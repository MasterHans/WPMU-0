...
<form role="search" method="get" class="woocommerce-product-search edgtf-product-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" id="woocommerce-product-search-field" class="search-field" placeholder="<?php echo esc_attr_x( 'Search', 'placeholder', 'ratio' ); ?>" value="<?php echo get_search_query(); ?>" name="s" title="<?php echo esc_attr_x( 'Search', 'label', 'ratio' ); ?>" />
