            ...
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" class="form">
                ...
                <?php else : ?>
                    ...
                    <div class="input-prepend">
                        <span class="add-on"><i class="fa fa-user"></i></span><input type="text" name="author" placeholder="Вася">
                    </div>

                    <label>Ваш e-mail*</label>
                    <div class="input-prepend">
                        <span class="add-on"><i class="fa fa-envelope"></i></span><input type="text" name="email" placeholder="vasya@mail.ru">
                    </div>

                    <label>Ваш сайт</label>
                    <div class="input-prepend">
                        <span class="add-on"><i class="fa fa-home"></i></span><input type="text" name="url" placeholder="http://vasya.ru">
                    </div>
