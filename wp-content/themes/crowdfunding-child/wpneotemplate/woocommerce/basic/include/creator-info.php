...
$company_name = empty(get_post_meta($post->ID, 'motivation_company_name', true)) ? 'Anonymous' : get_post_meta($post->ID, 'motivation_company_name', true);
?>

<div class="mt-campaign-creator-info-wrapper">
    <div class="mt-campaign-creator-avatar">
        <a href="javascript:;" class="wpneo-fund-modal-btn">
            <!--            --><?php // echo get_avatar($post->post_author, 42); ?>

            <?php
            if (MultiPostThumbnails::has_post_thumbnail($post->post_type,'company-creator-image',$post->ID)) :
                MultiPostThumbnails::the_post_thumbnail('product', 'company-creator-image', NULL, 'featured-image-42-42');
            else : ?>
                <img src="<?php echo get_stylesheet_directory_uri() . '/motivation/lib/img/anonymous.png' ?>" alt="" style="height: 42px; width: 42px">
            <?php endif; ?>
        </a>

        <p class="mt_author_name navy-700">By
            <a href="javascript:;" class="wpneo-fund-modal-btn">
                <?php echo $company_name; ?>
            </a>
        </p>

        <p class="mt_campaign_numbers navy-600"><?php echo wpneo_crowdfunding_author_all_campaigns()->post_count; ?>
            created</p>
    </div>
    ...
    <div class="wpneo-modal-content">
        ...
        <div class="wpneo-modal-content-inner">
            ...
            <div class="wpneo-profile-right">
                ...
                <?php } ?>
                <div
                    class="wpneo-profile-campaigns"><?php echo wpneo_crowdfunding_author_all_campaigns()->post_count . __(" Campaigns", "wp-crowdfunding") . ' | ' . wpneo_loved_campaign_count() . __(" Loved campaigns", "wp-crowdfunding"); ?></div>
            </div>
