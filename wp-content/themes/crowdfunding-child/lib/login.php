...
ob_start();
 ...
 if (username_exists($username)){
	...
	function motivation_login_form(){
	    global $errors_login;
	    echo $errors_login;
	    echo '
...
<!--				</a> -->
			    ...
			    <div class="form-group">
			    	...
			    	<input type="submit" class="btn btn btn--green btn--large btn-block" name="submit" value="'.__("Log In","crowdfunding").'"/>
			    </div>
		    ';
		if( $errors_login != '' ){
	...
	add_shortcode('motivation_custom_login', 'motivation_custom_login_shortcode');
	function motivation_custom_login_shortcode(){
