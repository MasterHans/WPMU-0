...
function theme_options_do_page() {
	...
	?>
	<div class="wrap">
		<?php screen_icon(); echo "<h2>" .  wp_get_theme()->get('Name') . __( ': Настройки', 'sampletheme' ) . "</h2>"; ?>
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Адрес(сокращённо)', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[shortaddresstext]" class="regular-text" type="text" name="sample_theme_options[shortaddresstext]" value="<?php esc_attr_e( $options['shortaddresstext'] ); ?>" />
					</td>
				</tr>
